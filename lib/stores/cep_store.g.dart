...
mixin _$CepStore on _CepStore, Store {
  Computed<String> _$cleanCepComputed;

  @override
  String get cleanCep => (_$cleanCepComputed ??=
          Computed<String>(() => super.cleanCep, name: '_CepStore.cleanCep'))
      .value;
